    ...
    <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
        ...
        <c:forEach items="${sessionScope.cart.items}" var="temp">
            <tr>
                <td>
                    <div class="c_s_img">
                        <a href="${ctx}/product/productDetail.action?id=${temp.product.id}"><img
                                src="${ctx}/statics/files/${temp.product.fileName}" width="73" height="73"/></a>
                    </div>
                        ${temp.product.name}
                </td>
        ...
        <tr valign="top" height="150">
            <td colspan="6" align="right">
                <a href="${ctx}/index.action"><img src="${ctx}/statics/images/buy1.gif" /></a>&nbsp;&nbsp;

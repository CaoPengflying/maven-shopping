...
<div class="log_bg">
    <div class="top">
        <div class="logo"><a href="${ctx}/index.action"><img src="${ctx}/statics/images/logo.png"/></a></div>
    </div>
    <div class="regist">
                ...
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    <tr height="50" valign="top">
                        ...
                        <td>
                            ...
                            <span class="fr">已有商城账号，<a href="${ctx}/toLogin.action" style="color:#ff4e00;">我要登录</a></span>
                        </td>
                    </tr>
                    <tr height="50">

...
<head>
    ...
    <%@ include file="/jsp/common/pre/header.jsp" %>
    <title>易买网</title>
</head>
<body>
<!--Begin Header Begin-->
<%@ include file="/jsp/common/pre/searchBar.jsp" %>
<!--End Header End-->
<!--Begin Menu Begin-->
<div class="menu_bg">
    <div class="menu">
                                ...
                                <div class="zj_l">
                                    <c:forEach items="${temp.productCategoryVoList}" var="vo">
                                        <div class="zj_l_c">
                                            <h2>
                                                <a
                                                        href="${ctx}/product/list.action?category=${vo.productCategory.id}&level=2
">${vo.productCategory.name}</a>
                                            </h2>
                                            <c:forEach items="${vo.productCategoryVoList}" var="vo2">
                                                <a href="${ctx}/product/list.action?category=${vo2.productCategory.id}&level=3">${vo2.productCategory.name}</a> |
                                            </c:forEach>
                                        </div>
                                    </c:forEach>
                                </div>
        ...
        <ul class="menu_r">
            ...
            <c:forEach items="${productCategoryVoList}" var="temp">
                <li><a href="${ctx}/product/list.action?level=1&category=${temp.productCategory.id}">${temp.productCategory.name}</a></li>
            </c:forEach>
        </ul>
...
<div class="i_bg bg_color">
    <div class="i_ban_bg">
        ...
        <div class="inews">
            <div class="news_t">
                <span class="fr"><a href="${ctx}/sys/news/queryNewsList.action">更多 ></a></span>新闻资讯
            </div>
            <ul>
                <c:forEach items="${news}" var="temp">
                    <li><span>[ 公告 ]</span>
                        <a href="${ctx}/sys/newsDetail.action?id=${temp.id}">${temp.title}</a>
                    </li>
                </c:forEach>
            </ul>
            <div class="charge_t">
            ...
            <div class="fresh_left">
                ...
                <div class="fresh_txt">
                    <div class="fresh_txt_c">
                        <c:forEach items="${temp.productCategoryVoList}" var="vo">
                            <a href="${ctx}/product/list.action?category=${vo.productCategory.id}&level=2
">${vo.productCategory.name}</a>
                        </c:forEach>
                    </div>
                </div>
    ...
    <%@ include file="/jsp/common/pre/footer.jsp" %>
</div>
</body>
</html>

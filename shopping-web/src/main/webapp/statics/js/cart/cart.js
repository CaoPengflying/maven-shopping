...
function addCartByParam(entityId,quantity){
    //添加到购物车
    $.ajax({
        url: contextPath + "/cart/addCart.action",
        method: "post",
        data: {
            entityId: entityId,
            quantity: quantity
...
function refreshCart(){
    $.ajax({
        url: contextPath + "/cart/refreshCart.action",
        method: "post",
...
function settlement1(){
    $.ajax({
        url: contextPath + "/sys/cart/settlement1.action",
        method: "post",
        success: function (jsonStr) {
        	refreshCart();
...
function settlement2(){
    $.ajax({
        url: contextPath + "/sys/cart/settlement2.action",
        method: "post",
        success: function (jsonStr) {
            $("#settlement").html(jsonStr);
        }
...
function settlement3(){
    ...
    $.ajax({
        url: contextPath + "/sys/cart/settlement3.action",
        method: "post",
        data: {
            addressId:addressId,
...
function modifyCart(entityId,quantity,obj){
	$.ajax({
        url: contextPath + "/sys/cart/removeCart.action",
        method: "post",
        data: {
            entityId:entityId,
            quantity:quantity
